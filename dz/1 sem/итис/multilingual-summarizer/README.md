...
![Tests](https://github.com/[username]/multilingual-summarizer/workflows/Tests%20and%20Code%20Quality/badge.svg)

> **Примечание:** Замените `[username]` на ваш GitHub username для отображения статуса CI/CD
